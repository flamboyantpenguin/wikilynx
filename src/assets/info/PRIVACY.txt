...
As of wikiLYNX 1.5.8, the application *does not collect* any type of data for statistics or for any other purposes. The app interacts with network only to make requests to fetch information (latest version, custom levels etc) and for browsing as mentioned below.
...
If you find any discrepancies in this document or if you have any queries/suggestions, contact [penguin@dawn.org.in](mailto:penguin@dawn.org.in).
